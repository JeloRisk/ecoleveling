<nav :class="{ 'flex': open, 'hidden': !open }"
    class=" flex z-1  w-full flex-row items-center justify-between gap-4 border-b border-gray-100 bg-[#242337] py-4 px-20">
    ...
    <div class="flex items-center w-full ">
        ...
        <div class="flex items-center align md:space-x-4  w-full justify-between">
            <div class="p-3 flex flex-row text-[#BEC1DC] text-[20px] font-semibold items-center gap-3">
                <img src="{{ url('/images/logo.png') }}" class="h-[2rem]" alt="Image" />
                <h1>ecoLEVELING</h1>
            </div>
            {{-- <x-header-main/> --}}
            <div class="flex flex-row text-white items-center gap-4">
                <a class="flex items-center text-[#BEC1DC] font-medium">
                    {{ __('Rooms') }}
                </a>
    
                <a class="flex items-center text-[#BEC1DC]">
                    {{ __('Reports') }}
                </a>
